	...
	<div class="container">
		<div class="forms-container">
			<div class="signin-signup">
				<form id="frmlogin" name="frmlogin" method="post" action="AdminLogin">
					...
					<input type="submit" value="Login" class="btn solid"
						onclick="javascript:form_submit('AdminLogin');" />
					<input type="hidden" id="actionType" name="actionType" value="Adminlogin" />
				</form>
			</div>
		</div>
	</div>

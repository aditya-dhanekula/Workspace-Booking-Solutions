...
public class WorkSpaceBookingDao {
	...
	private WorkSpaceBooking setObject(ResultSet rs) throws SQLException {
		...
		booking.setArrServices(getAllBookingServices(booking.getBookingId()));
	...
	private ArrayList<Service> getAllBookingServices(int BookingId){
		Connection con = null;
		try {
			con = Database.getConnection();
			
			PreparedStatement st = con.prepareStatement(
					"Select ServiceID, ServiceName, ServicePrice, UnitType FROM Services where ServiceId IN " 
							+ "(Select ServiceId from workSpaceBookings WHERE BookingId=?);");
			// System.out.println(st.toString());
	...
	public ArrayList<WorkSpaceBooking> getAllCustomerBookings(int customerId, int StaffId, Boolean excludeFuture, Boolean excludeRunning, Boolean excludePast, Boolean excludeCancelled){

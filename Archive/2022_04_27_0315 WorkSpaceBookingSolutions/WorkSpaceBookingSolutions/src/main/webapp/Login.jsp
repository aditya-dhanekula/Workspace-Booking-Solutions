			...
			<div class="signin-signup">
				...
				<form id="frmlogin" name="frmlogin" method="post" action="Login">
					...
					<input type="submit" value="Login" class="btn solid"
						onclick="javascript:form_submit('Login');" />
					<div>
						<span class="login__account">Don't have an Account ?</span> <a
							href="register"> <span class="login__signin" id="register">Register</span></a>
					</div>

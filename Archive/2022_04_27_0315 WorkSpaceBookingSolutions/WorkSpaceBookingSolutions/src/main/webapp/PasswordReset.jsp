...
<body>
	...
	<p align="center">
		<br />
		<br />New password updated Successfully!! Click the below link to login. <br /> <a href="Login">Login</a>
	</p>
	<%}
	else {
	%>
	<form id="frmPasswordReset" name="frmPasswordReset"
		...
		<table align="center" cellpadding="10">
			...
			<tr>
				<td>Username</td>
				<td><input type="text" id="username" name="username" value="<%=objUser.getUsername()%>" />
		...
		<input type="hidden" id="tp" name="tp" value="<%=objUser.getUserTypeId()%>">
		<input type="hidden" id="key" name="key" value="<%=objUser.getResetPasswordKey()%>">
	</form>

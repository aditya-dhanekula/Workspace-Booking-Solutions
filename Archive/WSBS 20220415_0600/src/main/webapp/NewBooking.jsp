			...
			<main class="dash-content">
		       ...
		       %>
					...
					<table class="table table-hover table-bordered">
			          ...
			          %>
					<td style="color: black; font-weight: bold; border: 1px solid black; text-align: left;"><%=objSpace.getWorkSpaceName()%> (Rs.<%=objSpace.getWorkSpacePrice()%>)</td>
					...
					<td style="color: black; font-weight: bold; border: 1px solid black; text-align: right;">
						<span align="left"> &#9733&#9734&#9734&#9734&#9734</span> <%=staff.getRating()%></td>
						...
						<% 
			            	...
			            	%>
			            		...
			            		Service objService=i.next();%>
									...
									<li style="text-align: left;" ><%=objService.getServiceName()%> (Rs.<%=objService.getServicePrice()%>)</li>
									<%} %>
					...
					<div id="divservices" align="center">
						<table class="table table-hover"
							style="border: 2px solid black; width: 75%;">
							<%if (arrServices != null){
						for (Iterator<Service> i=arrServices.iterator();i.hasNext();){
							Service objService=i.next();
							%>
							<tr>
								<td class=""
									...
									<label for="optedservices"><%=objService.getServiceName()%>
										(Rs.<%=objService.getServicePrice()%>)</label>
								</td>
								<td class=""

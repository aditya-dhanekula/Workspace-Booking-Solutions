		...
		<div class="dash-app">
			...
			<main class="dash-content">
				...
				<div class="container-fluid">
					...
					<p align="center">
						Thank you for submitting the Feedback. This helps us to improve
						our services. <br /> <a href="Bookings"> click hereto go back
							to Bookings </a>
					</h3>
					<%} else {%>
					...
					<div class="feedback">
						<p>
							Dear Customer,<br> Thank you for using our services. We
							would like to know how we performed. Please spare some moments to
							give us your valuable feedback as it will help us in improving
							our service.
						</p>

						<!-- <h4>Please rate your service experience for the following parameters</h4> -->

						<form id="frmFeeback" name="frmfeedback" method="post"
							action="Bookings">
							<label>1. Your overall experience with us?</label><br> <span
								class="star-rating"> <input type="radio"
								name="overallrating" value="1"><i></i> <input
								type="radio" name="overallrating" value="2"><i></i> <input
								type="radio" name="overallrating" value="3"><i></i> <input
								type="radio" name="overallrating" value="4"><i></i> <input
								type="radio" name="overallrating" value="5"><i></i>
							</span>

							<div class="clear"></div>
							<hr class="survey-hr">
							<label>2. Friendliness and courtesy shown to you while
								receiving your vehicle</label><br> <span class="star-rating">
							...
							<label for="m_3189847521540640526commentText">3. Any
								Other suggestions:</label><br /> <br />
							...
							<input type="hidden" id="actionType" name="actionType"
								value="cstfeedback" /> <input type="hidden" id="id" name="id"
								value="<%=objBooking.getBookingId()%>" />
						</form>
					</div>
					<%} %>
				</div>

...
<body style="width: 100%;">
	...
	<div class="dash">
		...
		<div class="dash-app">
			...
			<form id="frmService" name="frmService" method="post"
				action="Service">
				<h2 class="display-4"
					style="text-align: center; color: black; font-weight: bold;">Services</h2>
				<h2 class="display-6"
					style="text-align: center; color: black; font-weight: bold;">
					<button onClick="javascript:form_submit('add', 0)"
						class="button-81" role="button">Add Service</button>
				</h2>
				<br>

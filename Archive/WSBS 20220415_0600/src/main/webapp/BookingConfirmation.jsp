				...
				<div id="divsearchinfo" align="center">
					...
					<table class="table table-hover">
						...
						<thead class="thead-dark">
							...
							<td class="table-light" style="text-align: center;">Rs.<%=objBooking.getBooking().getWorkSpaceBookingCost()%></td>
							...
							<td class="table-light">
								...
								<ol>
									...
									<li><%=objService.getServiceName()%>&nbsp;(Rs.<%=objService.getServicePrice()%>)</li>
									<%}%>
						...
						<tr>
							<td colspan="4" style="text-align: center;" class="table-warning"><span
								class="PayInfo">Advance payment for the booking</span> Rs.<b>1000</b></td>
						</tr>
					</table>
				</div>
								...
								<div class="column shipping" align="center">
									...
									<div class="field full">
										<label for="payamount" style="font-size: 1.1em;">Amount
											...
											style="text-align: center; font-size: 1.5em;" value="1000"
											readonly>
									</div>
								</div>
							</div>
...
function form_submit(){
	<%if (objBooking.getCustomer().getWalletAmount()<1000)  {%>

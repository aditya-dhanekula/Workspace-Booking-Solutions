...
out.print("Action Type = " + ActionType);
...
<title>Car WorkSpace Solutions</title>
					...
					<div class="forms">
						<form id="frmStaffRegistration" name="frmStaffRegistration"
							...
							<table align="center" cellpadding="10">
								...
								<tr>
									<td colspan="2" align="center"><input type="button"
										id="btnSubmit" name="btnSubmit" class="button-81"
										onclick="javascript:form_submitcheck()" value="SUBMIT" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="password" id="ConfirmNewPassword"
										name="ConfirmNewPassword" /></td>
								</tr>
								<tr>
									<td colspan="2" align="center"><input type="button"
										id="btnResetPassword" name="btnResetPassword"
										class="button-81"
							...
							<input type="hidden" id="actionType" name="actionType"
								value="save"> <input type="hidden" id="id" name="id"
								value="<%=objUser.getUserId()%>">
						</form>
					</div>
				</div>

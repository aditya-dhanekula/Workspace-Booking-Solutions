...
public class WorkSpaceBooking {
	...
	private int WorkSpaceBookingCost=0;
	private int ChargedAmount=0;
	private int RefundAmount=0;
	private int BookingstatusId=61;
	...
	public int getWorkSpaceBookingCost() {
		return WorkSpaceBookingCost;
	}
	public void setWorkSpaceBookingCost(int workSpaceBookingCost) {
		WorkSpaceBookingCost = workSpaceBookingCost;
	}

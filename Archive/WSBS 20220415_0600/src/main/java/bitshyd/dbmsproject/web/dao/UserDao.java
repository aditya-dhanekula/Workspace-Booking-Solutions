...
public class UserDao {
	...
	public User getStaff(int userID) {
		...
		try {
			...
			//City, Pincode, EmailID, WorkLocationId, PhoneNo, StaffTotalPoints, StaffRatedMembersCount, TimeCreate, TimeUpdate
			PreparedStatement st = con.prepareStatement(
				    ...
				    + "St.StaffTotalPoints, St.StaffRatedMembersCount, "
	...
	private void setUserObject(User user, ResultSet rs) throws Exception {
		//Admin Fields: adminId, Username, UserPassword, UserStatusId, FirstName, LastName, 
		//EmailID, PhoneNo, ResetPasswordKey, ResetPasswordKeySetOn, TimeCreate, TimeUpdate
		
		//Staff Fields: StaffId, Username, UserPassword, UserStatusId, FirstName, LastName, 
		//EmailID, PhoneNo, ResetPasswordKey, ResetPasswordKeySetOn, TimeCreate, TimeUpdate,
		//DOB, Gender, ResidentialAddress, City, Pincode,  
		//WorkLocationId, StaffTotalPoints, StaffRatedMembersCount, 
		
		//Customer Fields: customerId, Username, UserPassword, UserStatusId, FirstName, LastName, 
		//EmailID, PhoneNo, ResetPasswordKey, ResetPasswordKeySetOn, TimeCreate, TimeUpdate
		//DOB, Gender, ResidentialAddress, City, Pincode, 
		//WalletAmount, 
		try {
	...
	private ArrayList<User> getAllStaffbyWorkLocation(int locationId, String statusList) {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement(
					...
					+ "u.StaffTotalPoints, u.StaffRatedMembersCount, "

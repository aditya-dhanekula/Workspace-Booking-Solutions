...
public class User {
	...
	private int ServiceTotalPoints = 0;
	...
	public double getServiceRating() {
		return Math.round((10.0d *ServiceTotalPoints) /StaffRatedMembersCount)/10 ;
	}
	...
	public int getServiceTotalPoints() {
		return ServiceTotalPoints;
	}

	public void setServiceTotalPoints(int serviceTotalPoints) {
		ServiceTotalPoints = serviceTotalPoints;
	}
